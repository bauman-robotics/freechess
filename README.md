...
2. Пока что, можно делать несколько ходов подряд за один цвет, даже, если играешь по правилам. 
    Проверка на очередность ходов пока не реализована.
...
4. Исправить. Вы "за белых" или "за черных". 
5. Сделать возможность копирование нотации в стандартном формате. 
6. Прикрутить базы данных, для хранения партий. 
